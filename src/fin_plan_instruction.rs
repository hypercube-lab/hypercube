...
pub struct Vote {
    ...
    /// liveness voting
    /// The version of the BLOCKTHREAD struct that the last_id of this network voted with
    pub version: u64,
    /// The version of the BLOCKTHREAD struct that has the same network configuration as this one
