//! The builtin tansaction module offers capabilities for generating system transactions from inside the framework of the system.
...
impl SystemTransaction for Transaction {
    /// Create and sign a new SystemProgram::CreateAccount transaction for your organization.
    fn system_create(
        from_keypair: &Keypair,
        to: Pubkey,
        last_id: Hash,
