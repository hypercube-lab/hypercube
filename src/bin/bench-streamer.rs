...
use clap::{App, Arg};
use hypercube::netutil::bind_to;
use hypercube::packet::{Packet, SharedPackets, BLOB_SIZE, PACKET_DATA_SIZE};
use hypercube::result::Result;
use hypercube::streamer::{receiver, PacketReceiver};
use std::cmp::max;
...
fn main() -> Result<()> {
    ...
    let matches = App::new("hypercube-bench-streamer")
        .arg(
