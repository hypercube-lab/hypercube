...
use hypercube::ncp::Ncp;
use hypercube::service::Service;
use hypercube::signature::{read_keypair, GenKeys, Keypair, KeypairUtil};
...
fn main() {
    ...
    let matches = App::new("hypercube-bench-tps")
    ...
    let v_threads: Vec<_> = nodes
        ...
        .map(|v| {
            ...
            Builder::new()
                .name("hypercube-client-sample".to_string())
                .spawn(move || {
    ...
    let s_threads: Vec<_> = (0..threads)
        .map(|_| {
            ...
            Builder::new()
                .name("hypercube-client-sender".to_string())
                .spawn(move || {
                    do_tx_transfers(
                        &exit_signal,
                        &shared_txs,
